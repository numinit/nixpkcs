        ...
        }:
        {
          ...
          overlayAttrs =
            ...
            in
            {
              ...
              openssl = openssl.overrideAttrs (
                finalPackage: previousPackage: with final; {
                    ...
                    withPkcs11Module =
                      ...
                      let
                        ...
                        config =
                          ...
                          in
                          writeText "${cnfPrefix}.openssl.cnf" (
                        ...
                        providerDebugLevel =
                          ...
                          in
                          if builtins.isString realDebug then
                            realDebug
                          else if builtins.isInt realDebug then
                            "file:/dev/stderr,level:${builtins.toString realDebug}"
                          else
                            null;
                      in
                      symlinkJoinWith {
              ...
              pkcs11-provider = pkcs11-provider.overrideAttrs (
                finalPackage: previousPackage: with final; {
                  passthru = (previousPackage.passthru or { }) // {
                    uri2pem = stdenv.mkDerivation {
                      ...
                      passthru.__functor =
                        self: uri:
                        pkgs.runCommand "pkcs11-uri2pem" { inherit uri; } ''
              ...
              nss_latest = nss_latest.overrideAttrs (
                finalPackage: previousPackage: {
                  passthru =
              ...
              tpm2-pkcs11 = tpm2-pkcs11.overrideAttrs (
                finalPackage: previousPackage: {
                  passthru =
                    (previousPackage.passthru or { })
                    // {
              ...
              yubico-piv-tool = yubico-piv-tool.overrideAttrs (
                finalPackage: previousPackage: {
                  passthru =
                    (previousPackage.passthru or { })
                    // {
